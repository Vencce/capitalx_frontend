...
import { FileText, Table, PlusCircle, Search, Settings2, ChevronDown, ChevronUp } from 'lucide-vue-next'
...
const cartasFiltradas = computed(() => {
  let filtradas = cartas.value.filter((c) => {
    // Busca Global (Código ou Administradora)
  ...
  <div class="home-container">
    ...
    <div class="filter-section-wrapper">
      <div class="filter-bar">
        <div class="filter-group">
          ...
          <div class="input-with-icon">
            ...
            <input type="text" v-model="buscaGlobal" placeholder="Código ou Administradora" />
          </div>
        </div>
        ...
        <div class="filter-actions">
          <button class="btn-advanced" @click="mostrarFiltrosAvancados = !mostrarFiltrosAvancados">
            <Settings2 :size="18" />
            {{ mostrarFiltrosAvancados ? 'Ocultar' : 'Avançado' }}
          </button>
      ...
      <Transition name="fade">
        <div v-if="mostrarFiltrosAvancados" class="advanced-filter-panel">
          <div class="filter-group">
