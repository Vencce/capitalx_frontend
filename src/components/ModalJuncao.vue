        ...
        <div class="modal-body">
          <div class="main-info">
            ...
            <div class="parcelamento-box">
              ...
              <div v-for="(p, index) in parcelasAgrupadas" :key="index" class="parcela-item-row">
              ...
              <div class="total-parcelas-footer">
                <p class="parcela-val">Soma das parcelas: <strong>{{ formatCurrency(totalParcelaMensal) }}</strong></p>
              </div>
            </div>
...
.section-label {
  color: #6b7280; font-size: 0.85rem; margin-bottom: 8px; font-weight: 700; text-transform: uppercase;
}
