...
const compartilhar = async () => {
  const dados = {
    ...
    text: `Confira: ${formatCurrency(props.carta.valor_credito)}`,
...
.card-horizontal:hover:not(.is-disabled) {
...
.card-horizontal.disponivel {
  border-left-color: #22c55e;
}
.card-horizontal.reservado {
  border-left-color: #f6d001;
}
.card-horizontal.vendido {
...
.modal-content.disponivel {
  border-top-color: #16a34a;
}
.modal-content.reservado {
  border-top-color: #f6d001;
}
.modal-content.vendido {
