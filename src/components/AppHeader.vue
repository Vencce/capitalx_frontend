...
.main-header {
  background: white;
  height: 90px; /* Aumentado levemente para acomodar a logo maior */
  position: sticky;
  top: 0;
  z-index: 1000;
...
.brand-logo {
  height: 60px; /* Logo aumentada de 45px para 60px */
  width: auto;
  object-fit: contain;
...
@media (max-width: 1024px) {
  ...
  .brand-logo {
    height: 50px; /* Um pouco menor no mobile para não ocupar tudo */
  }
