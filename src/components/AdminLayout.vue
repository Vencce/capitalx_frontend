  ...
  <div class="admin-layout">
    <aside class="sidebar">
      ...
      <div class="menu-container">
        ...
        <nav class="menu">
          ...
          <router-link
            to="/admin/cartas"
            class="menu-item"
            :class="{ active: isActive('/admin/cartas') }"
          >
        ...
        <nav class="menu">
          <router-link
            ...
            class="menu-item"
            :class="{ active: isActive('/admin/configuracoes') }"
          >
      ...
      <div class="sidebar-footer">
        <button @click="logout" class="menu-item btn-logout"><LogOut :size="20" /> Sair</button>
        <router-link to="/" class="btn-site"> <Globe :size="16" /> Ir para o Site </router-link>
      </div>
    </aside>
    ...
    <main class="main-content">
      <header class="top-bar">
        <div class="breadcrumbs">
          <span>Painel</span> <span class="separator">/</span>
